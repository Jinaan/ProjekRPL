...
(function() {
    ...
    */
    ...
    var Ba = function(a) {
            if (a instanceof t && a.constructor === t && a.ha === Aa) return a.T;
    ...
    var Ea = function(a) {
            if (a instanceof v && a.constructor === v && a.ga === Da) return a.R;
        ...
        Ga = function(a) {
            ...
            ta(Fa.test(a), "%s does not match the safe URL pattern", a) || (a = "about:invalid#zClosurez");
            return new v(Ca, a)
        },
        Da = {},
        Ca = {};
    ...
    var Ia = function(a) {
            if (a instanceof z && a.constructor === z && a.fa === Ha) return a.F;
    ...
    var Ja = new z;
    Ja.F = m.trustedTypes && m.trustedTypes.emptyHTML ? m.trustedTypes.emptyHTML : "";
    var Ka = {
            MATH: !0,
            SCRIPT: !0,
            STYLE: !0,
    ...
    var A = window,
        ...
        Wa = /'/g,
        Xa = function(a) {
            return String(a).replace(Ra, "&amp;").replace(Sa, "&lt;").replace(Ta, "&gt;").replace(Va, "&quot;").replace(Wa, "&#39;")
        },
        D = function() {
            var a;
            if ((a = Object.create) &&
    ...
    var J = function(a, b, c) {
        ...
        $a = new RegExp(/^/.source + /([a-zA-Z][-+.a-zA-Z0-9]*:)?/.source + /(\/\/[^\/?#]*)?/.source + /([^?#]*)?/.source + /(\?([^#]*))?/.source + /(#((#|[^#])*))?/.source + /$/.source),
        ab = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
        bb = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"),
        ...
        jb = function(a, b) {
            ...
            b = (new z).D(b);
            if (Ka[e.tagName.toUpperCase()]) throw Error("goog.dom.safe.setInnerHtml cannot be used to set content of " + e.tagName + ".");
            if (La())
    ...
    var Ab = function(a, b, c) {
        ...
        Cb = function(a, b, c) {
            b && 0 < b.length && (b = Bb(b), c && 0 < c.length && (b += "___" + Bb(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = C(zb, "_p", D()), C(b, c, D())[a] = (new Date).getTime(), Ab(a, "_p", c))
        },
        Bb = function(a) {
    ...
    var Fb = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Nb = function(a, b, c, d) {
            ...
            b = h;
            c = b.match(Kb);
            (d = b.match(Lb)) && 1 === d.length && Mb.test(b) && c && 1 === c.length || O("failed sanity: " + a);
            return h
        },
        Qb = function(a, b, c, d) {
            a = Ob(a);
        ...
        Ob = function(a) {
            ...
            c = 0;
            for (d = Gb.length; c < d; ++c) Gb[c].test(b) && O("invalid_prefix");
            c = Rb(a, "k", !0);
            d = Rb(a, "am");
            e = Rb(a, "rs");
            a = Rb(a, "t");
    ...
    var Tb = decodeURI("%73cript"),
        ...
        Wb = function() {
            var a = L.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(Ub) ? a : L.nonce = null : B.querySelector ? (a = B.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Ub) ? L.nonce = a : L.nonce = null) : null : null
        },
        Zb = function(a) {
        ...
        Xb = function(a) {
            ...
            b.async = "true";
            (a = B.getElementsByTagName(Tb)[0]) ? a.parentNode.insertBefore(b, a): (B.head || B.body || B.documentElement).appendChild(b)
        },
        $b = function(a, b) {
            var c = b && b._c;
            if (c)
    ...
    var ac = function(a, b) {
        if (L.hee && 0 < L.hel) try {
            ...
            b && b(c), L.hel--, dc("debug_error", function() {
                try {
    ...
    var ec = function(a) {
        ...
        jc = function(a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") ||
                (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = hc(f)) && b.push(f));
            a && ic(c, a);
            d = ec("cd");
            a = 0;
        ...
        pc = function() {
            if (!nc) {
                ...
                if (window.self !== window.top) {
                    ...
                    for (var e in mc) 0 < mc[e] && (b = J(a, e, "")) && (oc[e] = b)
                }
                nc = !0
            }
            e = D();
    ...
    var yc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        Ac = function(a) {
            ...
            null == b && (a = a || window.location.href, b = J(a, "authuser") ||
                null, null == b && (b = (b = a.match(yc)) ? b[1] : null));
        ...
        Bc = function(a) {
            ...
            null == b && (b = (a = (a || window.location.href).match(zc)) ? a[1] : null);
            if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null);
            return b
    ...
    var Cc, S, T = void 0,
        ...
        W = function(a, b) {
            ...
            if ("undefined" !== d) {
                ...
                if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a,
                        "toJSON") || (e !== Ic || a.constructor !== Array && a.constructor !== Object) && (e !== Hc || a.constructor !== Array && a.constructor !== Object) && e !== Gc && e !== Dc && e !== Fc && e !== Ec)) return W(a.toJSON.call(a), c);
                if (null == a) b[b.length] = "null";
                else if (e === Dc) a = Number(a), isNaN(a) || isNaN(a - a) ? a = "null" : -0 === a && 0 > 1 / a && (a = "-0"), b[b.length] = String(a);
        ...
        $c = function(a) {
            ...
            b = b.replace(Rc, "0");
            b = b.replace(Sc, "0");
            if (Tc.test(b) || Uc.test(b) || Vc.test(b) || Wc.test(b) || !b || (b = b.replace(Xc, ""))) return !1;
        ...
        cd = function(a) {
            if (-1 !== S) return ad(), T ? m.JSON.stringify.call(m.JSON, a) : W(a)
        },
    ...
    gd.prototype.digest = function() {
        var a = [],
            b = 8 * this.J;
        56 > this.o ? this.update(this.H, 56 - this.o) : this.update(this.H, this.j - (this.o - 56));
        for (var c = this.j - 1; 56 <= c; c--) this.L[c] = b & 255, b /= 256;
        hd(this, this.L);
        for (c = b = 0; 5 > c; c++)
    ...
    kd || (od = 1E6 * (screen.width * screen.width + screen.height), pd = rd(B.cookie + "|" + B.location + "|" + (new Date).getTime() + "|" + Math.random()), ld = Q("random/maxObserveMousemove") || 0, 0 != ld && lb("mousemove", qd, "add", "at"));
    var sd = function() {
            var a = nd;
    ...
    var yd = {
        ...
        Cd = function(a, b, c, d, e) {
            ...
            var f, g = vd(d, c),
                h = g ? wd(d) : "";
            try {
                document.all && (f = a.createElement('<iframe frameborder="' + Xa(String(c.frameborder)) + '" scrolling="' + Xa(String(c.scrolling)) + '" ' + h + ' name="' + Xa(String(c.name)) + '"/>'))
            } catch (l) {} finally {
                f ||
            ...
            for (var k in c) a = c[k], "style" === k && "object" === typeof a ? F(a, f.style) : zd[k] || f.setAttribute(k, String(a));
    ...
    var Id = function(a) {
        ...
        Jd = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = Id(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) return e
            }
    ...
    var Kd = {
        ...
        Pd = function(a, b, c) {
            ...
            Ld[a] || (f.origin = window.location.origin || window.location.protocol + "//" + window.location.host);
            f.exp = Q(g + "exp");
            if (g = Q(g + "location"))
            ...
            n = [].concat(Nd);
            (l = Q("iframes/" + a + "/methods")) && "object" === typeof l && Oa.test(l.push) && (n = n.concat(l));
            ...
            vc(function(b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = Pd(d, b, 0);
                        g ? (f = f.parentNode,
                            e.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, Td(f, b), (d = R[f.lastChild.id]) && (d.oid = c), wc(c, 4))) : delete R[c]
                    } else delete R[c]
                }
            })
        };
    var Vd, Wd, X, Xd, Yd, Zd = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        $d = {
            plusone: !0,
            autocomplete: !0,
            profile: !0,
        ...
        ae = function(a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                if (k.getAttribute("data-gapiscan")) h = null;
                    ...
                    var p =
                        l.indexOf("g:");
                    0 == p ? n = l.substr(2) : (p = (p = String(k.className || k.getAttribute("class"))) && Zd.exec(p)) && (n = p[1]);
                    h = !n || !(Vd[n] || Wd[n] || X[n]) || h && n !== h ? null : n
                }
                h && ($d[h] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != Ya(Sd(g)).length) && (g.setAttribute("data-gapiscan", !0), C(c, h, []).push(g))
            }
            if (b)
                for (var r in c)
            ...
            if (ce(Yd || {}))
                for (var y in c) {
                    ...
                    d = [];
                    for (y in c)
                        for (a = c[y], u = 0, b = a.length; u < b; u++) e = a[u], ee(y, e, Sd(e), d, b);
                    fe(r, d)
                }
        },
        ge = function(a) {
    ...
    var de = function(a, b) {
            ...
            switch (ke(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        g.siteElement =
                            k;
                        k.id || (b = k, C(Od, a, 0), f = "___" + a + "_" + Od[a]++, b.id = f);
                        b = D();
                        b[">type"] = a;
                        F(c, b);
                        f = h;
                        ...
                        e = b = f;
                        Dd.test(b) && (e = Q("iframes/" + e.substring(1) + "/url"), H(!!e, "Unknown iframe url config for - " + b));
                        f = jb(B, e.replace(Ed, Gd));
                        b = c.ownerDocument || B;
                        k = 0;
                        do e = h.id || ["I", Ad++, "_", (new Date).getTime()].join(""); while (b.getElementById(e) && 5 > ++k);
                        ...
                        n || (r = bd(J(b.location.href, "jcp", ""))) && "object" == typeof r && (n = (n = r.id) ? r.pfname + "/" + n : "");
                        p.pfname =
                            n;
                        h.connectWithJsonParam && (r = {}, r.jcp = cd(p), p = r);
                        r = J(f, "rpctoken") || k.rpctoken || l.rpctoken;
                        r || (r = h.rpctoken || String(Math.round(1E8 * (kd ? td() : sd()))), p.rpctoken = r);
                        h.rpctoken = r;
        ...
        ke = function(a, b, c) {
            if (a && 1 === a.nodeType && b) {
                if (c) return 1;
                if (X[b]) {
                    if (rb[a.nodeName.toLowerCase()]) return (a =
        ...
        Td = function(a, b) {
            ...
            if (d) {
                ...
                fe(c, e)
            } else sc("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    C(I, "platform", {}).go = be;
    ce = function(a) {
    ...
    Eb.push(["platform", function(a, b, c) {
        Yd = c;
        b && Xd.push(b);
        me(he, a);
            ...
            function d(f) {
                ...
                if (re(g, b)) {
                    ...
                    se(a, function() {
                        k && N("rqd");
                        c();
                        for (var l = C(L, "RPMQ", []), n = 0; n < l.length; n++) l[n]({
                            data: g,
                            origin: h
                        })
                    })
        ...
        re = function(a, b) {
            ...
            if (d.s && a && -1 != Pa.call(b, a)) {
                if ("_renderstart" === d.s || d.s === qe + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = B.getElementById(a), wc(a, 2), d && b && d.width && d.height) {
                        a: {
                            c = b.parentNode;a = d || {};
                            if (tc()) {
                                var e = b.id;
    ...
    var xe = "https:" === window.location.protocol,
        ...
        Ae = function() {
            ...
            ye.iterate(function(c, d) {
                0 === c.indexOf("G_AUTHUSER_") && (c = ze(c.substring(11)), !a || c.i && !a.i || c.i == a.i && c.l > a.l) && (a = c, b = d)
            });
            return {
                ja: a,
                K: b
    ...
    Z.prototype.aa = function() {
        this.M && (this.W() ? this.v = this.U : this.v = Math.min(2 * (this.v || this.U), 120), window.setTimeout(na(this.aa, this), 1E3 * this.v))
    };
    Z.prototype.v = 0;
    Z.prototype.U = 2;
    Z.prototype.W = null;
        ...
        dc("auth", {
            callback: function() {
                ...
                d.checkSessionState(e, function(f) {
                    ...
                    if (h = h != f) kc("isLoggedIn", f), uc(), Ud(), f || ((f = d.signOut) ? f() : (f = d.setToken) && f(null));
                    f = pc();
                    var k = Q("savedUserState");
                    g = d._guss(f.cookiepolicy);
                    k = k != g && "undefined" != typeof k;
                    kc("savedUserState", g);
                    (h || k) && qc(f) && !Q("disableRealtimeCallback") && d._pimf(f, !0)
                })
            }
        });
        return !0
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.WuHGBC70tdw.O/am\u003dwQc/d\u003d1/ct\u003dzgms/rs\u003dAGLTcCNpHoaMoiiRyTFOuGnNuTT-eiD9VA/m\u003d__features__",
