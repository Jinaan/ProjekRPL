...
(function() {
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        k = k.lastBackward();
                        u = u || h;
                        this.setStartAt(u, !u.is("br") && (!k && this.checkStartOfBlock() || k && u.contains(k)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
    ...
    (function() {
        ...
        function y(a, b, f, e) {
            ...
            if (e.doFilter) {
                ...
                if (!e.skipFinalValidation && !n(b)) return f.push(b), 1
            }
    ...
    (function() {
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
            ...
            f && (f = b.clone(), b.shrink(CKEDITOR.SHRINK_TEXT, !1, {
