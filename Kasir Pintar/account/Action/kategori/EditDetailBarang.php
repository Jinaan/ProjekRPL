...
<head>
  ...
  <meta charset="utf-8" />
  <link rel="icon" type="image/png" href="../../gambar/kasir_pintar.png">
  ...
  <!-- Bootstrap core CSS     -->
  <link href="https://kasirpintar.co.id/dashboard/css/bootstrap.min.css?v=1685859509" rel="stylesheet" />
  <link href="https://kasirpintar.co.id/dashboard/css/fresh-bootstrap-table.css?v=1685859509" rel="stylesheet" />


  <!--  Light Bootstrap Table core CSS    -->
  <link href="https://kasirpintar.co.id/dashboard/css/light-bootstrap-dashboard-v4.css?v=1685859509" rel="stylesheet" />
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.23/css/jquery.dataTables.min.css" />
  <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/select/1.3.0/css/select.dataTables.min.css" />

  <link href="https://kasirpintar.co.id/dashboard/css/kp.css?v=1685859509" rel="stylesheet" />
  <meta name="google-signin-client_id"
    content="433891833837-s9t6ombm4qo456h549qo5uqs1r3p9lsl.apps.googleusercontent.com">

  <!--     Fonts and icons     -->
  <script src="https://kasirpintar.co.id/source/js/feather.min.js?v=1685859509"></script>
  <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
  <script src="https://kasirpintar.co.id/source/js/platform.js?v=1685859509" async defer></script>
  <link href="https://kasirpintar.co.id/dashboard/css/morris.css?v=1685859509" rel="stylesheet" />
  <link href="https://kasirpintar.co.id/dashboard/css/MonthPicker.css?v=1685859509" rel="stylesheet" />
  <!-- <link href="https://fonts.googleapis.com/css?family=Asap|Lato" rel="stylesheet"> -->
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://kasirpintar.co.id/css/intlTelInput.css?v=1685859509">
  <link rel="stylesheet" href="https://kasirpintar.co.id/css/custom.css?v=1685859509">
  <link rel="stylesheet" href="https://kasirpintar.co.id/vendor/toastr/toastr.min.css?v=1685859509">
    ...
    <div class="wrapper">
        <div style="background-color: #00AF81" class="sidebar">
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href=".." class="simple-text logo-normal"><img src="../../images/logo_kasirpintar_white.webp"
                    ...
                    <li class="panel">
                        ...
                        <div class="collapse bg-green-dark" id="pengaturan">
                            <ul class="nav" id="accordionSub">
                                ...
                                <!--                            <li class=""><a href="../../account/toko" ><p>Toko</p></a></li>
                            
                            -->

                                <li class="">
                                    <a href="../../account/pengaturan.php">
                                        <p>Reset Data</p>
                                    </a>
                                </li>

                                <!-- 
                                <li style='opacity: 35%' class="">
                                    <a href="../../account/struk">
                                        <p>Struk</p>
                                    </a>
                                </li> -->
                                <li class="">
                                    <a href="../../account/listOthers.php">
                                        <p style='opacity: 35%'>Manajemen Staff</p>
                                    </a>
                                </li>
            ...
            <nav class="navbar navbar-default drop-shadow" style="background: #fff; border: none; margin-bottom: 0px">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a href="http://kasirpintar.co.id">
                            <div class="logo" style="display: inline-block;">
                                <!-- <img src="../../gambar/kasir_pintar.png" alt="Kasir Pintar Logo" style="display:inline-block; width:40px; margin:10px;">
                            <b style="vertical-align: middle; color: #009688"></b> -->
                            </div>
                        </a>
                            ...
                            <div class="mobileShow">
                                ...
                                <ul class="dropdown-menu" style="z-index: 1000">
                                    <li class="font-12 medium font-gray-bold"><a href="../../account">Masuk
                                            sebagai<br><span class="font-14 font-black">Pusat : Maxxel</span></a></li>
      ...
      <script src="https://kasirpintar.co.id/source/js/select2.min.js?v=1685859509"></script>
      ...
      <script src="https://kasirpintar.co.id/dashboard/js/kp.js?v=1685859509"></script>
      <link href="https://kasirpintar.co.id/assets/css/cropper.min.css" rel="stylesheet" />
      <script src="https://kasirpintar.co.id/assets/js/cropper.min.js" type="text/javascript"></script>
      <link href="https://kasirpintar.co.id/dashboard/css/select_data_table.css" rel="stylesheet" />
      <script src="https://kasirpintar.co.id/source/js/jquery.dataTables.min.js"></script>
      <script src="https://kasirpintar.co.id/source/js/dataTables.bootstrap.min.js"></script>
      <script src="https://kasirpintar.co.id/source/js/dataTables.select.min.js"></script>
      <script src="https://kasirpintar.co.id/source/js/dataTables.buttons.min.js"></script>
      <script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.2/dist/jquery.validate.min.js"></script>
      <script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.2/dist/additional-methods.min.js"></script>
      <link href="https://kasirpintar.co.id/source/css/select2.min.css" rel="stylesheet" />
      <link rel="stylesheet" href="https://kasirpintar.co.id/vendor/spinner-animate/three-quarters.css">
      <link rel="stylesheet" href="https://kasirpintar.co.id/vendor/spinner-animate/custom.css">
      <link rel="stylesheet" href="https://kasirpintar.co.id/source/css/bootstrap-select.min.css">
      <link rel="stylesheet" href="https://kasirpintar.co.id/vendor/progress-bar/progress-bar.css">
      <style>
        .tablinks {
          cursor: pointer;
          color: #606060;
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <img src="https://kasirpintar.co.id/plugin/ingredients.png" alt="Food Menu" class="img-responsive"
                  width="15%" style="margin: auto;">
              </div>
              <div class="modal-footer">
                <button type="button" class="btn button-feature" style="margin-top: 5px"
                  data-dismiss="modal">batal</button>
                <a href="https://kasirpintar.co.id/account/plugin" class="btn button-primer button-mg">Lanjutkan</a>
              </div>
            </div>
          </div>
        </div>
...
<!-- ////////////////////////////////////////////////////////////////////// -->
  ...
  <script type="text/javascript" src="https://kasirpintar.co.id/source/js/moment.min.js"></script>
  <script type="text/javascript" src="https://kasirpintar.co.id/source/js/daterangepicker.min.js"></script>
  <link rel="stylesheet" type="text/css" href="https://kasirpintar.co.id/source/css/daterangepicker.css" />
  <style>
    .select2-results__message {
      display: none !important;
    }
  ...
  <script src="https://kasirpintar.co.id/source/js/select2.min.js"></script>

  <script src="https://kasirpintar.co.id/vendor/ckeditor/ckeditor.js"></script>
...
<!--   Core JS Files   -->
<script src="https://kasirpintar.co.id/dashboard/js/bootstrap.min.js?v=1685859509" type="text/javascript"></script>
<!--  Checkbox, Radio & Switch Plugins -->
<script src="https://kasirpintar.co.id/dashboard/js/bootstrap-checkbox-radio-switch.js?v=1685859509"></script>

<!--  Notifications Plugin    -->
<script src="https://kasirpintar.co.id/dashboard/js/bootstrap-notify.js?v=1685859509"></script>

<!--  Select Plugin    -->
<script src="https://kasirpintar.co.id/dashboard/js/bootstrap-selectpicker.js?v=1685859509"></script>

<!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
<script src="https://kasirpintar.co.id/dashboard/js/light-bootstrap-dashboard.js?v=1685859509"></script>

<!-- Light Bootstrap Table DEMO methods, don't include it in your project! -->
<script src="https://kasirpintar.co.id/dashboard/js/demo.js?v=1685859509"></script>
<script src="https://kasirpintar.co.id/js/sorttable.js?v=1685859509" type="text/javascript"></script>
<script src="https://kasirpintar.co.id/vendor/toastr/toastr.min.js?v=1685859509"></script>
...
<script src="https://kasirpintar.co.id/source/js/platform.js?onload=onLoad" async defer></script>
